...
FCKeditor.prototype._GetIFrameHtml = function()
{
	...
	return '<iframe id="' + this.InstanceName + '___Frame" src="' + sLink + '" width="' + this.Width + '" height="' + this.Height + '" style="height:' + this.Height + 'px; width:' + this.Width + 'px;" frameborder="no" scrolling="no"></iframe>' ;
}
