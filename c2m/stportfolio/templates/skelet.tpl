...
<LINK href="{$smarty.const.DOCROOT}css/stylesheet.css" type=text/css rel=stylesheet>
<SCRIPT src="{$smarty.const.DOCROOT}js/chrome.js" type=text/javascript></SCRIPT>

<SCRIPT src="{$smarty.const.DOCROOT}js/tabber.js" type=text/javascript></SCRIPT>
