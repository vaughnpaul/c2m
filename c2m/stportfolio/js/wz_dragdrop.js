...
dd.getPageXY = function(d_o)
{
	...
	else
	{
		...
		while(d_o)
		{
			dd.x += dd.Int(d_o.offsetLeft>0?d_o.offsetLeft:d_o.style.left);
			dd.y += dd.Int(d_o.offsetTop>0?d_o.offsetTop:d_o.style.top);
...
dd.reposition = function()
{
	var d_o, d_i = dd.elements.length; while(d_i--)
	{
		d_o = dd.elements[d_i];
		document.getElementById(d_o.id).style.left = d_o.x;
		document.getElementById(d_o.id).style.top = 10;
	}
}
